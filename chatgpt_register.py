...
DUCKMAIL_DOMAIN = str(_CONFIG.get("duckmail_domain", "duckmail.sbs") or "").strip().lstrip("@")
...
def _extract_duckmail_domains(data) -> list:
    if isinstance(data, dict):
        candidates = data.get("hydra:member") or data.get("member") or data.get("data") or data.get("domains") or []
